...
def check_config_json() -> None:
    ...
    assert "FunctionTool" in runtime, "llm_tool_function_tool_missing"
    assert "self.context.add_llm_tools" in runtime, "llm_tool_add_llm_tools_missing"
    assert "StarTools.register_llm_tool" not in runtime, "deprecated_register_llm_tool_present"
    assert "StarTools.unregister_llm_tool" not in runtime, "deprecated_unregister_llm_tool_present"
