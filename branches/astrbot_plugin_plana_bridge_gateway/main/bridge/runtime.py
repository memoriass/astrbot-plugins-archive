...
from .adapter_registry import build_capability_registry
from .credential import ProtectedFileCredentialProvider
from .core_inprocess import CoreInProcessAdapter
from .domain_tools import DomainToolMixin
...
class PlanaBridgeGatewayPlugin(DomainToolMixin, ProactiveRuntimeMixin, Star):
    ...
    def __init__(self, context: Context, config: AstrBotConfig):
        ...
        self.credential_provider = ProtectedFileCredentialProvider(
            data_dir / str(self.config.get("credential_store_directory", "credentials") or "credentials")
        )
